...
foreach ($stmt as $row){
    ...
    $html .=  '<td><button class="edit show-delivery" data-ID_ZP="'.findIDZP($row['Id_zamowienia'],$pdo).'" data-ID_P="'.findIDP($row['Id_zamowienia'],$pdo).'"><img src="../../images/show.png" style="width: 30px" alt=""></button></td>';    $html .=  '</tr>';
}
...
<script src="../../js/ShowDetailOrderUsers.js"></script>
</body>
</html>